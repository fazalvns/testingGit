# IHS-LMS-WebApp Contributor's Guide

Below is our guidance for how to report issues, propose new features, and submit contributions via Pull Requests (PRs).

## Open Development Workflow

The IHS-LMS-WebApp is VERY active in this GitHub Repo. In fact, we live in it all day long and carry out all our development in the open!
...
[SECURITY.md](https://github.com/IHS-LMS/webapp/blob/master/SECURITY.md) for more information.
...
Specs are written in markdown, stored under the `wiki` and named `[issue id] - [spec description].md`.
...
Thank you in advance for your contribution! Now, [what's next on the list](https://github.com/IHS-LMS/webapp/issues)? 😜
